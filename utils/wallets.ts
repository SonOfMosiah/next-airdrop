...
export const isCoinbaseWallet = () => {
    ...
    return !!(
        ...
        (ethereum?.providers &&
            ethereum?.providers.find((provider: any) => provider.isCoinbaseWallet))
    );
};
...
export const isFrame = () => {
    ...
    return !!(
        ethereum?.isFrame ||
        (ethereum?.providers &&
            ethereum?.providers.find((provider: any) => provider.isFrame))
    );
};
...
export const isInfinityWallet = () => {
    ...
    return !!(
        ...
        (ethereum?.providers &&
            ethereum?.providers.find((provider: any) => provider.isInfinityWallet))
    );
};
...
export const isRainbow = () => {
    ...
    return !!(
        ethereum?.isRainbow ||
        (ethereum?.providers &&
            ethereum?.providers.find((provider: any) => provider.isRainbow))
    );
};
...
export const isZerion = () => {
    ...
    return !!(
        ethereum?.isZerion ||
        (ethereum?.providers &&
            ethereum?.providers.find((provider: any) => provider.isZerion))
    );
};